    ...
    <div style={{ padding: 0 }} className="space-y-5">
      ...
      <Card style={{ borderRadius: 16 }} styles={{ body: { padding: 16 } }}>
        <div className="space-y-4">
          ...
          {/* Steps Timeline / Return Alert */}
          {isInReturn ? (
            <div className="p-3 my-2 bg-red-50 border border-red-400 rounded-xl text-center text-red-700 font-bold text-xs flex items-center justify-center gap-2">
              <WarningOutlined style={{ fontSize: 16, color: "#dc2626" }} />
              <span>🚚 অর্ডারটি কুরিয়ার থেকে রিটার্ন ফেরত আসছে (In-Return Transit)। অফিসে পৌঁছালে '📦 Returned' সিলেক্ট করুন।</span>
            </div>
              ...
              {courierStatusState && (
                (() => {
                  ...
                  const attempts = courierAttemptState || (
                    (courierReasonState && courierInfo.isReady) ? 2 : 0
                  );
