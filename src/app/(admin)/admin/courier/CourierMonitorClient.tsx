          ...
          <div className="space-y-1">
            ...
            {trackingId ? (
              <>
                ...
                {provider === "pathao" && (
                  <a
                    href={`https://merchant.pathao.com/public-tracking?consignment_id=${trackingId}`}
                    target="_blank"
    ...
    },
    {
      ...
      render: (_, record) => {
        ...
        const attempts = record.courierAttemptCount || (
          (record.courierReason && courierInfo.isReady) ? 2 : 0
        );
        ...
        return (
          <div className="space-y-1.5" style={{ maxWidth: 320 }}>
            <div className="flex items-center gap-2 flex-wrap">
              ...
              >
                <span>{courierInfo.label}</span>
                {!courierInfo.isDelivered && attempts > 1 && (
                  <span
                    style={{
            ...
            {!courierInfo.isDelivered && record.courierReason && (
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-5 gap-2 pt-1 items-start">
                    ...
                    <div className="col-span-3 space-y-3.5 text-left min-w-0">
                      {/* Order ID Badge with Provider Tag */}
                      <div className="mb-2 flex items-center gap-1.5 flex-wrap">
                        ...
                        ) : item.courierProvider === "steadfast" ? (
                          <Tag color="blue" style={{ margin: 0, fontWeight: 800, fontSize: "10px", background: "#dbeafe", color: "#1d4ed8", border: "1px solid #bfdbfe" }}>
                            🦅 Steadfast
                          </Tag>
                        ) : (
                    ...
                    <div className="col-span-2 space-y-3.5 text-left min-w-0 flex flex-col items-start pl-3">
                      ...
                      <div className="mb-2">
                        {(() => {
                          const courierInfo = parseCourierStatus(
                            item.courierStatus,
                            item.courierLastLogDesc,
                            item.courierRiderName,
                            item.courierRiderPhone
                          );

                          const attempts = item.courierAttemptCount || (
                            (item.courierReason && courierInfo.isReady) ? 2 : 0
                          );
